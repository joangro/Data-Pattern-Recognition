function [itrfin] = multisvm( T,C,test, kernel_type )
...
for tempind=1:itrind
    ...
    if(N>2)
        ...
        %This while loop is the multiclass SVM Trick
            c1=(C==u(itr));
            newClass=c1;
            svmStruct = svmtrain(T,newClass,'kernel_function',kernel_type);   % I am using rbf kernel function, you must change it also
